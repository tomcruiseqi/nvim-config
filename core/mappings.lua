...
keymap.set(
	...
	"<leader>q",
	"<cmd>x<cr>",
	{ silent = true, desc = "quit current window" }
)
...
keymap.set(
	...
	"[l",
	"<cmd>lprevious<cr>zv",
	{ silent = true, desc = "previous location item" }
)
keymap.set(
	"n",
	"]l",
	"<cmd>lnext<cr>zv",
	{ silent = true, desc = "next location item" }
)
...
keymap.set(
	...
	"[L",
	"<cmd>lfirst<cr>zv",
	{ silent = true, desc = "first location item" }
)
keymap.set(
	"n",
	"]L",
	"<cmd>llast<cr>zv",
	{ silent = true, desc = "last location item" }
)
...
keymap.set(
	...
	"[q",
	"<cmd>cprevious<cr>zv",
	{ silent = true, desc = "previous qf item" }
)
keymap.set(
	"n",
	"]q",
	"<cmd>cnext<cr>zv",
	{ silent = true, desc = "next qf item" }
)
...
keymap.set(
	...
	"[Q",
	"<cmd>cfirst<cr>zv",
	{ silent = true, desc = "first qf item" }
)
keymap.set(
	"n",
	"]Q",
	"<cmd>clast<cr>zv",
	{ silent = true, desc = "last qf item" }
)
...
keymap.set(
	"x",
	"<A-k>",
	'<cmd>call utils#MoveSelection("up")<cr>',
